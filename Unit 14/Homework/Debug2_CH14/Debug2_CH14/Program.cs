...
class DebugFourteen2
{
    static void Main()
    {
        ...
        FileStream outFile = new FileStream(FILENAME, FileMode.Create, FileAccess.Write);// added new
        ...
        while (stu.StuNum != END)//Change to Does not equal
        {
            Write("Enter last name ");
            stu.Name = ReadLine();

            Write("Enter grade point average ");//add ;
            ...
            stu.StuNum = Convert.ToInt32(ReadLine());//add 32 to ToInt32
        }
...
public class Student
{
    private int stuNum;
    private string name;
    private double gpa;//corrected spelling
