...
class DebugFour2
{
    static void Main()
    {
        ...
        //Changes the logic because it it was if the number was going in reverse
        if (num1 < num2 && num2 <= num3)
            WriteLine("Numbers are in sequential order");

        else
        //Changes the logic because it it was if the number was going in sequential
            if (num1 > num2 && num2 >= num3)
